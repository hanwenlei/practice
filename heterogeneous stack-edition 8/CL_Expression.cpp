...
char* CL_Expression::EvaluateExp(char* input, CL_IStack* OpterStack, CL_IStack* OpvalStack)
{
...
double CL_Expression::ResultExp(char* input, char* ch, int* index, CL_IStack* OpterStack, CL_IStack* OpvalStack)
{
	double TempDouble = 0;
...
double CL_Expression::PutResult(char* ch, CL_IStack* OpterStack, CL_IStack* OpvalStack)
{
