...
{  
	CL_Stack* OpterStack = new CL_Stack(40);
	CL_Stack* OpvalStack = new CL_Stack(40);  
    
    m_result = HelpEvaluateExp(input, OpterStack, OpvalStack);
...
double CL_Expression::HelpEvaluateExp(char* input, CL_Stack* OpterStack, CL_Stack* OpvalStack)
{
    ...
    {  
        ...
        {  
            count = 0;     
            TempDouble = ResultExp(input, &c, &InputCount, OpterStack, OpvalStack);  
        }
...
double CL_Expression::ResultExp(char* input, char* ch, int* index, CL_Stack* OpterStack, CL_Stack* OpvalStack)
{
	double TempDouble = 0;
    ...
    {  
        ...
        case '=':
			...
			*ch = input[(*index)++];                  
            break;  
        case '>': 
        	TempDouble = PutResult(ch, OpterStack, OpvalStack);
	}
	return TempDouble;
}

double CL_Expression::PutResult(char* ch, CL_Stack* OpterStack, CL_Stack* OpvalStack)
{
